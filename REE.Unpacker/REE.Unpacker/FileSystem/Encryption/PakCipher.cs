...
namespace REE.Unpacker
{
    class PakCipher
    {
        ...
        private static readonly Byte[] m_K6 = new Byte[] {
            0xBB, 0x28, 0xC5, 0x40, 0x58, 0x45, 0xBE, 0xDA, 0x37, 0xC6, 0x86, 0xDB, 0xA5, 0x12, 0xFD, 0xB2,
            0xC0, 0x84, 0x40, 0x23, 0xEB, 0x54, 0x29, 0x4F, 0xF6, 0xBB, 0x05, 0x02, 0xE5, 0xF0, 0x0E, 0x5A,
        };
        ...
        public static Byte[] iGetEncryptionKey(Byte[] lpBlobHash)
        {
            ...
            switch (PakUtils.iGetStringFromBytes(lpHash))
            {
                ...
                //Resident Evil 4 -> re_chunk_000.pak.patch_003.pak
                case "9A7C2EFA077476847C9B76A14E881A6D181022C3": return m_K6;
                default: break;
            }
